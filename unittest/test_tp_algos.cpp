...
static vector<int> MaximizeCell(int** flow_cqi, vector<int>& slice_quota_rbgs,
...
static vector<int> VogelApproximate(int** flow_cqi,
...
int main() {
  ...
  auto rbg_to_slice =
      VogelApproximate(flow_cqi, slice_quota_rbgs, nb_rbgs, nb_slices);
