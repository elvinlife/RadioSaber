  ...
  class EventMemberImpl1 : public Event {
   public:
    EventMemberImpl1(OBJ obj, MEM function, T1 a1)
        : m_obj(obj), m_function(function), m_a1(a1) {}
  ...
  class EventMemberImpl1b : public Event {
   public:
    EventMemberImpl1b(OBJ obj, MEM function, T1 a1, T2 a2)
        : m_obj(obj), m_function(function), m_a1(a1), m_a2(a2) {}
  ...
  class EventMemberImpl1b : public Event {
   public:
    EventMemberImpl1b(OBJ obj, MEM function, T1 a1, T2 a2, T3 a3)
        : m_obj(obj), m_function(function), m_a1(a1), m_a2(a2), m_a3(a3) {}
...
Event* MakeEvent(void (*f)(U1), T1 a1) {
  ...
  class EventFunctionImpl2 : public Event {
   public:
    ...
    EventFunctionImpl2(F function, T1 a1) : m_function(function), m_a1(a1) {}

   protected:
    virtual ~EventFunctionImpl2() {}

   private:
    virtual void RunEvent(void) { (*m_function)(m_a1); }
    F m_function;
    T1 m_a1;
