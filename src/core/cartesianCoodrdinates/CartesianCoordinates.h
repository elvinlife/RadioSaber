...
class CartesianCoordinates {
 ...
 public:
  ...
  void SetCoordinatesFromPolar(CartesianCoordinates *center, double radius,
                               double angle);
  double GetDistance(CartesianCoordinates *remoteObject);
  double GetDistance(double remoteObjectPosX, double remoteObjectPosY);
  double GetPolarAzimut(CartesianCoordinates *center);
