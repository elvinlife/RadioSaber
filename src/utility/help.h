...
static void Help (void)
{
	...
	std::cout <<
			...
			"\n"
			"\t ./LTE-Sim SingleCellCustomize nbCells radius nbUE nbVoip nbVideo nbBE nbCBR sched_type frame_struct speed maxDelay videoBitRate seed(optional)"
			...
			"\n\n\n"
			"\n\t legend:"
			"\n\t\t schd_type: 1-> PF, 2-> M-LWDF, 3-> EXP, 4-> FLS, 5 -> Optimize EXP Rule, 6 -> Optimized LOG Rule, 7->NVS Scheduler, 8->Greedy Scheduler, 9->Oracle Scheduler"
