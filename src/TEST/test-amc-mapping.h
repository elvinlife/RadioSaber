...
static void TestAmcMapping(int nbCells, double radius, int speed,
                           double bandwidth, int cluster) {
  ...
  ue->GetPhy()->SetBandwidthManager(
      eNBs->at(0)->GetPhy()->GetBandwidthManager());
