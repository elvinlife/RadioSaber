...
class Header {
 public:
  ...
  void SetProtocolHeader(ProtocolHeader protocolHeader);
  ProtocolHeader GetProtocolHeader(void) const;
...
class TransportHeader : public Header {
 public:
  ...
  void SetProtocolType(TransportProtocol::TransportProtocolType protocol);
  TransportProtocol::TransportProtocolType GetProtocolType(void) const;
...
class IPHeader : public Header {
 public:
  ...
  int GetDestinationID(void) const;
...
class MACHeader : public Header {
 public:
   ...
   */
  void SetMACsourceID(int id);
  int GetMACsourceID(void) const;
  void SetMACdestinationID(int id);
  int GetMACdestinationID(void) const;
