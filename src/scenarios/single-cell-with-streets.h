...
static void SingleCellWithStreets(double radius, int nbStreets, int nbUE,
                                  int nbFemtoUE, int nbVoIP, int nbVideo,
                                  int nbBE, int nbCBR, int sched_type,
  ...
  int nbFemtoCells =
      nbStreets * 2 * nbOfBuildingInStreet * femtoCellsInBuilding;
  int firstFemtoinBuildingID = nbCell;
  int buildingtype = 0;  // 0: 5x5 grid

  nm->CreateStreet(streetID, streetCenter, theta, buildingtype,
