...
MacroCellSubUrbanAreaChannelRealization::
    MacroCellSubUrbanAreaChannelRealization(NetworkNode* src,
                                            NetworkNode* dst) {
...
void MacroCellSubUrbanAreaChannelRealization::SetPenetrationLoss(double pnl) {
  m_penetrationLoss = pnl;
}

double MacroCellSubUrbanAreaChannelRealization::GetPenetrationLoss(void) {
  return m_penetrationLoss;
}

double MacroCellSubUrbanAreaChannelRealization::GetPathLoss(void) {
  /*
...
void MacroCellSubUrbanAreaChannelRealization::SetShadowing(double sh) {
  m_shadowing = sh;
}

double MacroCellSubUrbanAreaChannelRealization::GetShadowing(void) {
  return m_shadowing;
}

void MacroCellSubUrbanAreaChannelRealization::UpdateModels() {
...
std::vector<double> MacroCellSubUrbanAreaChannelRealization::GetLoss() {
#ifdef TEST_PROPAGATION_LOSS_MODEL
