...
void NetworkNode::SetIDNetworkNode(int id) {
  m_idNetworkNode = id;
}

int NetworkNode::GetIDNetworkNode(void) const {
  return m_idNetworkNode;
}

void NetworkNode::SetNodeType(NodeType type) {
  m_nodeType = type;
}

NetworkNode::NodeType NetworkNode::GetNodeType(void) const {
  return m_nodeType;
}
...
Cell* NetworkNode::GetCell(void) {
  return m_cell;
}

void NetworkNode::SetProtocolStack(ProtocolStack* stack) {
  m_protocolStack = stack;
}

ProtocolStack* NetworkNode::GetProtocolStack(void) const {
  return m_protocolStack;
}

void NetworkNode::SetClassifier(Classifier* classifier) {
  m_classifier = classifier;
}

Classifier* NetworkNode::GetClassifier(void) const {
  return m_classifier;
}
...
void NetworkNode::SetMobilityModel(Mobility* m) {
  m_mobility = m;
}

Mobility* NetworkNode::GetMobilityModel(void) {
  return m_mobility;
}

void NetworkNode::SetNodeState(NodeState state) {
  m_state = state;
}
...
void NetworkNode::SendPacketBurst(PacketBurst* p) {
