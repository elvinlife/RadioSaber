run_onecase() {
    ...
    for i in $(seq 0 2); do
        ...
        ../../LTE-Sim SingleCellWithI 3 1 $allue 0 0 1 0 10 1 30 0.1 128 $i ${ue}ues/config 2> ${ue}ues/upperbound_mt$i.log > /dev/null &
        ../../LTE-Sim SingleCellWithI 3 1 $allue 0 0 1 0 11 1 30 0.1 128 $i ${ue}ues/config 2> ${ue}ues/maxcell_mt$i.log > /dev/null &
